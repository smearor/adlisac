...
graph TD
    ...
    style A fill: #04e762,color:#ffffff
    style B fill: #f5b700,color:#ffffff
    style C fill: #00a1e4,color:#ffffff
    style D fill: #dc0073,color:#ffffff
    style E fill: #89fc00,color:#ffffff
```
